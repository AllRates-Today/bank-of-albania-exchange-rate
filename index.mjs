// Bank of Albania exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/boa';
...
/** Latest rate for one pair, e.g. getRate('EUR', 'ALL', { apiKey }). */
